...
char** str_split(char* a_str, const char a_delim)
{
   ...
   char  currentdir[PATH_MAX] = "/home/aigerim/Desktop/systemprog/Bash-system-programming-project-" ;
    ...
    void print_dir_with_hidden(int ishidden,int inode,int m,int x,int r){
           int fd, nread;
           char buf[BUF_SIZE];
           ...
           int ii=0;
           char thisdir[80];
           strcpy(thisdir,currentdir);
           fd = open(thisdir, O_RDONLY | O_DIRECTORY);
           if (fd == -1)
               handle_error("open");
               ...
               for (bpos = 0; bpos < nread;) {
                   ...
                   if (x==1){
                      ...
                      if(d_type==DT_DIR){
                        ...
                        strcat(currentdir,"/");
                        strcat(currentdir,d->d_name);
                        printf("nested:\n");
                        print_dir_with_hidden(0,0,1,0,1);
            ...
            *message = get_line ();
            ...
            if (strcmp(option,"ls")==0) {
               ...
               int a=0,i=0,m=0,j=1,x=0,r=1;
                ...
                print_dir_with_hidden(a,i,m,x,r);
       }
